var utils = browserRequire('./src/utils');

window.JEngine = module.exports = utils.Obj.extend({
...
JEngine.Utils = utils;
JEngine.Renderers = browserRequire('./src/renderers');
JEngine.Scene = browserRequire('./src/scene');
JEngine.GameObject = browserRequire('./src/game_object');